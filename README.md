...
- Fidelización Invertida: monitorización de categorías (Plata, Oro, Diamante) para detectar la salud del programa de lealtad.
...
- Estrategias de Upselling: Análisis de inventario para fomentar el paso de habitaciones Dobles Interiores a Exteriores basándose en la rentabilidad por categoría.
